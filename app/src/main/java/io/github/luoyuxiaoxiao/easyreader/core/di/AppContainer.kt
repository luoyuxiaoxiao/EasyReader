...
import io.github.luoyuxiaoxiao.easyreader.data.settings.ThemeSettingsStore
...
class AppContainer(context: Context) {
    ...
    val themeSettingsStore: ThemeSettingsStore by lazy {
        ThemeSettingsStore(applicationContext)
    }
